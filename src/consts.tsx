...
const HubBaseUrl = `${window.location.protocol !== "https:" ? "http" : "https"}://${HubHost}${HubPort.length > 0 && HubPort[0] === "/" ? "" : ":"}${HubPort}`
const HubWsUrl = `${window.location.protocol !== "https:" ? "ws" : "wss"}://${HubHost}${HubPort.length > 0 && HubPort[0] === "/" ? "" : ":"}${HubPort}/ws`
const HubScriptLogsWsUrl = `${window.location.protocol !== "https:" ? "ws" : "wss"}://${HubHost}${HubPort.length > 0 && HubPort[0] === "/" ? "" : ":"}${HubPort}/scripts/logs`
